    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 bg-slate-800/30 rounded-xl border border-slate-800 flex items-center gap-3">
          ...
          <span className="text-xs font-medium text-slate-400">Optimized for GPT-4 & Claude</span>
        </div>
        <div className="p-4 bg-slate-800/30 rounded-xl border border-slate-800 flex items-center gap-3">
          <div className="bg-indigo-500/10 p-2 rounded-lg text-indigo-400">
            <Terminal size={16} />
          </div>
          <span className="text-xs font-medium text-slate-400">Zero-Shot & CoT Logic</span>
        </div>
        <div className="p-4 bg-slate-800/30 rounded-xl border border-slate-800 flex items-center gap-3">
          <div className="bg-amber-500/10 p-2 rounded-lg text-amber-400">
            <Sparkles size={16} />
          </div>
          <span className="text-xs font-medium text-slate-400">Professional Persona Injection</span>
        </div>
      </div>
    </div>
  );
