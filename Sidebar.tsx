    ...
    <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-screen sticky top-0 overflow-y-auto">
      ...
      <nav className="flex-1 px-4 space-y-2 py-4">
        ...
        <div className="pt-6">
          ...
          >
            <HelpCircle size={20} />
            <span className="font-medium text-sm">FAQ & Help</span>
          </button>
        </div>
      </nav>
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="bg-slate-800/50 rounded-xl p-4">
          <p className="text-[10px] text-slate-400 mb-1 font-bold uppercase">Free Tier</p>
          <p className="text-xs font-semibold text-slate-200">10 Prompts Remaining</p>
